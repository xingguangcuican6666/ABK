...
def main():
    ...
    if "--lang" in sys.argv:
        ...
        if idx + 1 < len(sys.argv) and sys.argv[idx + 1] in ("zh-cn", "en-us", "ru-ru", "ja-jp", "ko-kr", "hi-in", "de-de", "fr-fr", "es-es", "pt-br", "neko", "eo"):
    ...
    parser.add_argument("--lang", choices=["zh-cn", "en-us", "ru-ru", "ja-jp", "ko-kr", "hi-in", "de-de", "fr-fr", "es-es", "pt-br", "neko", "eo"], help=t("help_lang"))
